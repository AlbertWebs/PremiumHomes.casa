...
<section class="headings">
    <div class="text-heading text-center">
        <div class="container">
            ...
            <h2><a href="{{url('/')}}">Home </a> &nbsp;/&nbsp; Privacy Policy</h2>
        </div>
    </div>
</section>
...
<section class="faq service-details bg-white">
    ...
    <ul>
        ...
        <li>
        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Premium Homes Limited, Namgoi Road, off Eldoret-Kitale Rd, Kitale.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to Premium Homes Limited, accessible from <a href="https://www.premiumhomes.casa" target="_blank">https://www.premiumhomes.casa</a></p>
        </li>
        <li>
    ...
    <ul>
        <li>
        <p>By email: hello@premiumhomes.casa</p>
        </li>
        <li>
        <p>By visiting this page on our website: <a href="https://premiumhomes.casa/contact-us" target="_blank">https://premiumhomes.casa/contact-us</a></p>
        </li>
    </ul>
                    <p></p>
