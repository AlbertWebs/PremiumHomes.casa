...
<head>
    ...
    <meta name="subject" content="{{$user->name}} - {{$user->position}} - Premium Homes">
    <meta name="rating" content="General">
    <meta name="referrer" content="no-referrer">
    <meta name="theme-color" content="#bf9d34">

    <title>{{$user->name}} - {{$user->position}} - Premium Homes</title>
    <meta name="description" content="{{$user->position}}">
    <link rel="canonical" href="https://premiumhomes.casa/"/>
    <meta name="author" content="Designekta Studios">

    <meta property="og:description" content="{{$user->position}}">
    <meta property="og:site_name" content="Premium Homes">
    <meta property="og:image" content="{{url('/')}}/uploads/team/{{$user->image}}" />
    <meta property="fb:app_id" content="431980657174772" />
    <meta property="og:title" content="{{$user->name}} - {{$user->position}} - Premium Homes" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://premiumhomes.casa/" />

    <meta name="twitter:title" content="{{$user->name}} - {{$user->position}} - Premium Homes" />
