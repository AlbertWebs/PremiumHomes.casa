            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-12 col-xs-12 royal-add-property-area section_100 pl-0 user-dash2">
                        ...
                        <form action="{{route('save-nearby-post',[$Nearby->id])}}" method="POST" enctype="multipart/form-data">
                            @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <p>
                                                    ...
                                                    <input required type="text" value="{{$Nearby->amenities}}" name="amenities" id="title" placeholder="Enter your property title">
                                                </p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12">
                                                <p class="no-mb">
                                                    ...
                                                    <input type="text" value="{{$Nearby->proximity}}" name="proximity" placeholder="USD" id="price" required>
                                                </p>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-6 col-md-12 dropdown faq-drop">
                                                <div class="form-group categories">
                                                    ...
                                                    <select name="category" class="nice-select form-control wide" required>
                                                        <option selected value="{{$Nearby->category}}">{{$Nearby->category}}</option>
                                                        <?php
                                            ...
                                            <div class="col-lg-6 col-md-12 dropdown faq-drop">
                                                <div class="form-group categories">
                                                    ...
                                                    <select name="rating" class="nice-select form-control wide" required>
                                                        <option selected value="{{$Nearby->rating}}">{{$Nearby->rating}}</option>
