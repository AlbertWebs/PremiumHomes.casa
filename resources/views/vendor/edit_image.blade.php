            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-12 col-xs-12 royal-add-property-area section_100 pl-0 user-dash2">
                        ...
                        <form action="{{route('save-image-post')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="property-form-group">
                                    <div class="row">
                                        ...
                                        <div class="container col-md-6">
                                            ...
                                            @if($select=="image")
                                            <img style="border-radius:10px" id="frame" src="{{url('/')}}/uploads/users/{{$Profile->image}}" class="img-fluid" />
                                            @else
                                            <img style="border-radius:10px" id="frame" src="{{url('/')}}/uploads/users/{{$Profile->avatar}}" class="img-fluid" />
                                            @endif
                                            <center>
                                               <small><strong>Current {{$select}}<strong></small>
                                            </center>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @if($select=="image")
                            <input type="hidden" value="{{$Profile->image}}" name="featured_image_cheat">
                            @else
                            <input type="hidden" value="{{$Profile->avatar}}" name="featured_image_cheat">
                            @endif
