        ...
        <div class="sb2-2">
            <div class="sb2-2-2">
                <ul>
                    ...
                    <li class="active-bre"><a href="#"> Add Properties</a>
                    </li>
                    <li class="page-back"><a href="{{url('/')}}/admin/blog"><i class="fa fa-backward" aria-hidden="true"></i> All Properties</a>
                    </li>
                </ul>
            ...
            <div class="sb2-2-add-blog sb2-2-1">
                <div class="box-inn-sp">
                    ...
                    <div class="bor">
                        <form method="POST" action="{{url('/')}}/admin/add_Properties" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="row">
