        ...
        <div class="sb2-2">
            <div class="sb2-2-2">
                <ul>
                    ...
                    <li class="active-bre"><a href="#"> Add How It Works</a>
                    </li>
                    <li class="page-back"><a href="{{url('/')}}/admin/how"><i class="fa fa-backward" aria-hidden="true"></i> How It Works</a>
                    </li>
                </ul>
            ...
            <div class="sb2-2-add-blog sb2-2-1">
                <div class="box-inn-sp">
                    <div class="inn-title">
                        ...
                        <p> Create How it Works Instructions </p>
                        <center>
                    ...
                    <div class="bor">
                        <form method="POST" action="{{url('/')}}/admin/add_How" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="row">
