...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $Property = Property::where('Status','Sale')->where('active','Approved')->orderBy('id','ASC')->limit('6')->get();
        $PropertyRent = Property::where('Status','Rent')->where('active','Approved')->orderBy('id','ASC')->get();
