...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $Property = Property::where('Status','Sale')->where('home','1')->where('active','Approved')->where('type', '!=' , "Plot")->orderBy('id','DESC')->limit('6')->get();
        $PropertyRent = Property::where('Status','Rent')->where('home','1')->where('active','Approved')->where('type', '!=' , "Plot")->orderBy('id','DESC')->limit('6')->get();
